...
public class CursoODBMySQL extends ODB implements CursoODB{
	...
	public void insert (Curso curso) {
		String campos = "nombre, cupo_minimo, cupo_maximo, fecha_inicio, fecha_fin, contenido_especifico, clases, horas, instructor, responsable, sala, programa";
		String valores = "'"+curso.getNombre()+"', "+curso.getCupoMinimo()+", "+curso.getCupoMaximo()+", ";
		valores += "'"+curso.getFecha_inicio()+"', '"+curso.getFecha_fin()+"', '"+curso.getContenido()+"', "+curso.getCantidadClases()+", ";
	...
	private List<Curso> selectByCondicion(String condicion) {
		...
		String campos = "curso_ID, nombre, cupo_minimo, cupo_maximo, fecha_inicio, fecha_fin, contenido_especifico, clases, horas, instructor, responsable, sala, programa";
